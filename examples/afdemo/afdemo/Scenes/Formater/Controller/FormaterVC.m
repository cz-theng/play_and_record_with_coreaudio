/*******************************************************************************\
** afdemo:FormaterVC.m
** Created by CZ(cz.devnet@gmail.com) on 16/6/30
**
...
- (IBAction)onFormatListItem:(id)sender {
...
- (IBAction)onExtFormatInfo:(id)sender {
